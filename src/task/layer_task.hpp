...
#define LayerTaskIn InitData<ftype>, FwdData<ftype>, BwdData<ftype>
#define LayerTaskOut InitData<ftype>, FwdData<ftype>, BwdData<ftype>
#define LayerTaskType 3, LayerTaskIn, LayerTaskOut

class LayerTask : public hh::AbstractCUDATask<LayerTaskType> {
  public:
    LayerTask(std::string const &name, cudnnHandle_t cudnn_handle,
              cublasHandle_t cublas_handle, size_t idx, LayerDimentions const &dims)
