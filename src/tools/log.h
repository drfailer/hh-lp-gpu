...
#define INFO_GRP_LAYER_TASK 1
#define INFO_GRP_CUDNN 2
#define INFO_GRP_CUBLAS 3
#define INFO_GRP_CUBLAS_OPS 4
#define INFO_GRP_PIPELINE_STEP 5
// clang-format off
#define INFO_GRPS              \
    INFO_GRP_CUDNN,            \
    INFO_GRP_CUBLAS,           \
    /* INFO_GRP_LAYER_TASK, */      \
    /* INFO_GRP_PIPELINE_STEP, */   \
    /* INFO_GRP_CUBLAS_OPS, */      \
    0
// clang-format on
